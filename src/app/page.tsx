  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 font-sans">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-center">
        <h1 className="text-3xl font-bold mb-4 text-blue-800">Welcome to ScholarProof</h1>
        <p className="mb-8 text-gray-600">Secure, verifiable academic documents for students and staff.</p>
