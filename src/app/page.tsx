  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 font-sans">
      <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md w-full max-w-md text-center">
        <h1 className="text-3xl font-bold mb-4 text-blue-800 dark:text-blue-200">Welcome to ScholarProof</h1>
        <p className="mb-8 text-gray-600 dark:text-gray-300">Secure, verifiable academic documents for students and staff.</p>
